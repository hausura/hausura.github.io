...
public class CountryArrayManager {
    ...
    public void add(CountryData countryData, int index) {
        /* TODO */
        if (index >= this.countryDataArray.length) {
            allocateMore();
        }
    ...
    public void remove(int index) {
        /* TODO */
        for (int i = index; i < this.countryDataArray.length; i++) {
            this.countryDataArray[i]=this.countryDataArray[i+1];
        }
        this.countryDataArray[length]=null;
        correct();
    }
    ...
    public CountryData[] filterContinent(String continent) {
        ...
        int count=0;
        for (int i = 0; i < this.countryDataArray.length; i++) {
            if (this.countryDataArray[i].getContinent()== continent) {
                count++;
            }
        }
        ...
        for (int i = 0; i < this.countryDataArray.length; i++) {
            if (this.countryDataArray[i].getContinent()== continent) {
                newArray[count]=countryDataArray[i];
                count++;
            }
        }
        return newArray;
    ...
    public CountryData[] filterMostPopulousCountries(int howMany) {
        ...
        sortDecreasingByPopulation();
        System.arraycopy(this.countryDataArray, 0, newArray, 0, howMany);
        return newArray;
    }
